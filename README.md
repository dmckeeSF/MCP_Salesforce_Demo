...
> [!NOTE]
> MCP Agent Actions are not accessible via Apex. Therefore, we need to treat the MCP server as a standard integration. The Named credentials created from the MCP Server registration process can be reused.==
